...
public class EspecificacionesCliente {
     public static Specification<Cliente> nombreIgualA(String nombre) {
    ...
    public static Specification<Cliente> buscar(String criterio) {
